...
public class ReadMedicineByType implements Option {

	@Override
	public String getOption() {
		return "Search Medicine By Type";
	}
	...
	public void oper(Database database, JFrame parent, Employee e) {
		...
		JButton search = new JButton("Search", 18);
		search.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				String select = "SELECT * FROM `medicines` WHERE `Type` LIKE '"
						+type.getText()+"';";
